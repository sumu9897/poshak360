...
const Orders = () => {
    ...
    const loadOrderData = async () => {
      try {
        ...
        const response = await axios.post(serverUrl  + '/api/order/userorders', {},{headers:{token}})
    ...
    <div className='border-t pt-16'>
      ...
      <div>{
        orderData.slice(1,4).map((item, index)=>(
            <div key={index} className='py-4 border-y  border-gray-300 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
