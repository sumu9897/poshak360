  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
        ...
        switch(method){
            ...
            case 'cod':
                const response = await axios.post(serverUrl + '/api/order/place',orderData,{headers: {token}})
                ...
                break;
            case 'stripe':
              const responseStripe = await axios.post(serverUrl + '/api/order/stripe',orderData,{headers: {token}})
